...
CREATE TABLE `tl_dma_eg_fields` (
  ...
  `eval_maxlength` varchar(10) NOT NULL default '0',
  `eval_minlength` varchar(10) NOT NULL default '0',
  `eval_rows` varchar(10) NOT NULL default '5',
  `eval_cols` varchar(10) NOT NULL default '100',
  ...
  `subpaletteSelector` varchar(10) NOT NULL default '0',
